Public Class Form1
    ...
    Private Sub cbdepartamentos_SelectedValueChanged(sender As Object, e As EventArgs) Handles cbdepartamentos.SelectedValueChanged
        asignarmunicipios(cbdepartamentos.SelectedItem, 1)
    End Sub

    Private Sub cbdepartamento_SelectedValueChanged(sender As Object, e As EventArgs) Handles cbdepartamento.SelectedValueChanged
    ...
    Private Sub CheckBox13_CheckedChanged(sender As Object, e As EventArgs) Handles checkdiario.CheckedChanged
    ...
    Private Sub CheckBox6_CheckedChanged(sender As Object, e As EventArgs) Handles checkdomingo.CheckedChanged
